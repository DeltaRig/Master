...
void example() {
    ...
    int n = 6;
    double s1[] = {4., 2, 4, 4, 4, 4, 4}; // 0
    double s2[] = {0., 1, 2, 0, 0, 0, 0}; // 1
    double s3[] = {1., 0, 1, 1, 1, 1, 1}; // 2
    double s4[] = {0., 1, 1, 1, 1, 1, 1}; // 3
    double s5[] = {0., 1, 2, 0, 0, 1, 0}; // 4
    double s6[] = {1., 2, 0, 0, 0, 0, 0}; // 5
